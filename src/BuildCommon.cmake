...
set_target_properties(libsdsl PROPERTIES IMPORTED_LOCATION "${CMAKE_BINARY_DIR}/lib/libsdsl.a")
add_dependencies(libsdsl sdsl)
target_include_directories(libsdsl INTERFACE "${sdsl_SOURCE_DIR}/include")
