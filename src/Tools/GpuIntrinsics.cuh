...
/**
 * @file GpuIntrinsics.cuh
 * @brief Contains device functions which are not in any cuda header files but
 * are defined by the cuda/hip compiler. Used for better autocompletion and
 * linting
 */
